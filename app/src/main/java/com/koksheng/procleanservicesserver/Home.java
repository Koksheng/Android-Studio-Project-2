...
import com.koksheng.procleanservicesserver.ViewHolder.MenuViewHolder;
...
//        startService(service);
    ...
    private void deleteCategory(String key) {
        ...
        DatabaseReference cleanings = database.getReference("Cleanings");
        Query cleaningInCategory = cleanings.orderByChild("menuId").equalTo(key);
        cleaningInCategory.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
