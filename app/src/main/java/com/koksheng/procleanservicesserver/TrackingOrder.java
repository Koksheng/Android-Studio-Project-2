...
import com.koksheng.procleanservicesserver.Common.DirectionJSONParser;
import com.koksheng.procleanservicesserver.Remote.IGeoCoordinates;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void drawRoute(final LatLng yourLocation, String address) {
        mServices.getGeoCode(address,"AIzaSyDjIHBNN6v03KFX337KXKmcnJ94to8mNcU" ).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                try{
                    ...
                    mServices.getDirections(yourLocation.latitude+","+yourLocation.longitude,
                                                orderLocation.latitude+","+orderLocation.longitude,"AIzaSyDjIHBNN6v03KFX337KXKmcnJ94to8mNcU")
                            .enqueue(new Callback<String>() {
                                @Override
                                public void onResponse(Call<String> call, Response<String> response) {
                                    new ParsekTask().execute(response.body().toString());
                                }
    ...
    private class ParsekTask extends AsyncTask<String,Integer,List<List<HashMap<String,String>>>> {
